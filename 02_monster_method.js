/**
 * Now we will add a handy method to our objects by updating our LivingThing Class.
 *
 * Copy your code from the previous exercise, then add a method named "isAlive" to the class.
